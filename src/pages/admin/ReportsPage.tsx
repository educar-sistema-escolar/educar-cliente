...
const displayReportValue = (value: unknown): string => {
  if (value === null || value === undefined || value === '') return '—';
  if (Array.isArray(value)) return value.map(displayReportValue).join(', ');
  if (typeof value === 'object') return Object.values(value).map(displayReportValue).join(' · ') || '—';
  return String(value);
};
