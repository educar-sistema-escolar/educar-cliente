...
export function ReportsPage() {
  ...
  const load = useCallback(async () => {
    ...
    } catch (loadError) { setError(loadError instanceof Error ? loadError.message : 'No se pudo cargar el reporte.'); } finally { setLoading(false); }
